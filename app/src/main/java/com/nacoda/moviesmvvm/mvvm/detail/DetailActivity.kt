...
class DetailActivity : BaseActivity() {
    ...
    private fun setupFragment() {
        ...
        DetailFragment.newInstance(intent.getSerializableExtra(getString(R.string.detail_intent)) as Movie).let {
            replaceFragmentInActivity(this,
                    DetailFragment.newInstance(intent.getSerializableExtra(getString(R.string.detail_intent)) as Movie),
                    R.id.detail_header_frame)
