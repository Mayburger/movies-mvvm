...
class MainMoviesActivity : BaseActivity() {
    ...
    private fun setupFragment() {
        ...
        PopularFragment.newInstance().let {
            replaceFragmentInActivity(this, PopularFragment.newInstance(), R.id.movies_frame_popular)
        }

        supportFragmentManager.findFragmentById(R.id.movies_frame_top)
        TopFragment.newInstance().let {
            replaceFragmentInActivity(this, TopFragment.newInstance(), R.id.movies_frame_top)
        }
    }
